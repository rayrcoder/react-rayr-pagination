...
var RayrPagination = function (_React$Component) {
    _inherits(RayrPagination, _React$Component);

    function RayrPagination(props) {
        _classCallCheck(this, RayrPagination);

        var _this = _possibleConstructorReturn(this, (RayrPagination.__proto__ || Object.getPrototypeOf(RayrPagination)).call(this, props));
    ...
    _createClass(RayrPagination, [{
        ...
        value: function toPage(item, page) {
            ...
            this.setState({ currentPage: item, goPage: page === 'go-page' ? item : '' }, function () {
        ...
        value: function isShow(count) {
            ...
            var last_input_length = ('' + lastpage).split('').length;
            var input_length = ('' + this.state.goPage).split('').length || last_input_length;
            ...
            if (count === 0 || count === null) {
                ...
                return _react2.default.createElement(
                    'div',
                    { className: 'rayr-page-container ' + this.state.className },
                    _react2.default.createElement(
                        'ul',
                        { className: 'rayr-page ' + (this.state.size + '-rayr-page') },
                        _react2.default.createElement(
                            'li',
                        ...
                        lastpage > 5 && [_react2.default.createElement(
                            'li',
                            { className: 'li-go-text', key: 'go' },
                            _react2.default.createElement(
                                'span',
                                null,
                                '\u524D\u5F80'
                            )
                        ), _react2.default.createElement('input', { key: 'input', size: input_length + 1, min: '1', max: '' + lastpage, maxLength: last_input_length, title: '\u8F93\u5165\u6709\u8BEF', className: 'input-go', value: this.state.goPage,
                            ...
                            onKeyDown: function onKeyDown(e) {
                                if (e.keyCode === 13) {
                                    if (_this3.state.goPage >= 1 && _this3.state.goPage <= lastpage && parseInt(_this3.state.goPage) !== page) {
                                        _this3.toPage(_this3.state.goPage, 'go-page');
                                        e.target.blur();
                                    }
                                }
                            }
                            ...
                            'li',
                            { key: 'page', className: 'li-page-text' },
                            _react2.default.createElement(
                                'span',
                                null,
                                '\u9875'
    ...
    return RayrPagination;
}(_react2.default.Component);

RayrPagination.propTypes = {
...
RayrPagination.defaultProps = {
    count: null,
    currentPage: 1,
    perPage: 10,
    size: 'md'
};
exports.default = RayrPagination;
